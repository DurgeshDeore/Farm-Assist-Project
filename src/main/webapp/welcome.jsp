...
<div class="input-group">
  <input type="search" name="txtsearch" class="form-control rounded" placeholder="Search" aria-label="Search" aria-describedby="search-addon" />
  <input type="submit" name="btnsearch" class="btn btn-outline-primary" data-mdb-ripple-init value="Search" id="searchbtn"></input>
</div>
...
<Td> -->
  ...
  <input type="submit" name="btnsearchbycat" class="btn btn-outline-primary" data-mdb-ripple-init value="Search By Catagories" id="searchbtn"></input>
</td>
</tr>
...
while(rs.next()){
	...
	<img class="prodimg" height=200px src="admin/images/<%out.println(rs.getString("pimage")); %>">
	</tD>
	</tr>
	<tr>
	<td>
	...
	<tR>
	<tD>
	<a href="viewdetails.jsp?id=<%out.println(rs.getString("pid"));%>"><input type="button" class="btn btn-success" value="View Details" id="viewdetailsbtn"></a>
	</tD>
	</tR>
	</table></div>
